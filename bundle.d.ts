 ...
 * @public
 */
declare type ActionResult = 'continue' | 'abort' | 'respond';
 ...
 * @public
 */
declare interface BrowserConnectOptions {
    /**
 ...
 * @public
 */
declare class BrowserContext extends EventEmitter {
    private _connection;
    private _browser;
    private _id?;
    /**
 ...
 * @public
 */
declare const enum BrowserContextEmittedEvents {
    /**
 ...
 * @public
 */
declare interface BrowserContextOptions {
    /**
 ...
 * @public
 */
declare const enum BrowserEmittedEvents {
    /**
 ...
 * @public
 */
declare interface BrowserFetcherOptions {
    platform?: Platform;
    product?: string;
    path?: string;
    host?: string;
 ...
 * @public
 */
declare interface BrowserFetcherRevisionInfo {
    folderPath: string;
 ...
 * @public
 */
declare interface BrowserLaunchArgumentOptions {
    /**
 ...
 * @internal
 */
declare const CDPSessionEmittedEvents: {
 ...
 * @public
 */
declare type ChromeReleaseChannel = 'chrome' | 'chrome-beta' | 'chrome-canary' | 'chrome-dev';

/**
 * @public
 * {@inheritDoc Puppeteer.clearCustomQueryHandlers}
 */
declare function clearCustomQueryHandlers(): void;
 ...
 * @internal
 */
declare interface CommonPuppeteerSettings {
 ...
 * @internal
 */
declare const ConnectionEmittedEvents: {
    readonly Disconnected: symbol;
};
 ...
 * @public
 */
declare interface ConnectOptions extends BrowserConnectOptions {
 ...
 * @internal
 */
declare const connectToBrowser: (options: BrowserConnectOptions & {
    browserWSEndpoint?: string;
    browserURL?: string;
    transport?: ConnectionTransport;
}) => Promise<Browser>;
 ...
 * @public
 */
declare interface ConsoleMessageLocation {
    /**
 ...
 * @public
 */
declare type ConsoleMessageType = 'log' | 'debug' | 'info' | 'error' | 'warning' | 'dir' | 'dirxml' | 'table' | 'trace' | 'clear' | 'startGroup' | 'startGroupCollapsed' | 'endGroup' | 'assert' | 'profile' | 'profileEnd' | 'count' | 'timeEnd' | 'verbose';
 ...
 * @internal
 */
declare function createJSHandle(context: ExecutionContext, remoteObject: Protocol.Runtime.RemoteObject): JSHandle;
 ...
 * @public
 */
declare interface CustomQueryHandler {
 ...
 */
declare function customQueryHandlerNames(): string[];
 ...
 * @public
 */
declare const DEFAULT_INTERCEPT_RESOLUTION_PRIORITY = 0;
 ...
 */
declare let devices: DevicesMap;

/**
 * @public
 */
declare type DevicesMap = {
    [name: string]: Device;
};
 ...
 * @public
 */
declare let errors: PuppeteerErrors;
 ...
 * @public
 */
declare const EVALUATION_SCRIPT_URL = "__puppeteer_evaluation_script__";
 ...
 * @internal
 */
declare const FrameManagerEmittedEvents: {
 ...
 * @internal
 */
declare function getQueryHandlerAndSelector(selector: string): {
...
declare class HTTPResponse {
     ...
     * @public
     */
    declare interface InterceptResolutionState {
        action: InterceptResolutionAction;
        priority?: number;
    }
     ...
     */
    declare type InterceptResolutionStrategy = InterceptResolutionAction;
     ...
     * @internal
     */
    declare interface InternalQueryHandler {
     ...
     * @public
     */
    declare class JSHandle<HandleObjectType = unknown> {
        /**
         * @internal
         */
     ...
     * @internal
     */
    declare const keyDefinitions: Readonly<Record<KeyInput, KeyDefinition>>;
     ...
     */
    declare function launch(options?: LaunchOptions & BrowserLaunchArgumentOptions & BrowserConnectOptions & {
        product?: Product;
     ...
     * @internal
     */
    declare class LifecycleWatcher {
     ...
     * @public
     */
    declare let networkConditions: PredefinedNetworkConditions;
     ...
     * @internal
     */
    declare const NetworkManagerEmittedEvents: {
     ...
     * @public
     */
    declare const enum PageEmittedEvents {
     ...
     * @public
     */
    declare interface PageEventObject {
        close: never;
     ...
     * @internal
     */
    declare interface PaperFormatDimensions {
        width: number;
        height: number;
    }
     ...
     * @internal
     */
    declare const paperFormats: Record<PaperFormat, PaperFormatDimensions>;
     ...
     * @public
     */
    declare type Permission = 'geolocation' | 'midi' | 'notifications' | 'camera' | 'microphone' | 'background-sync' | 'ambient-light-sensor' | 'accelerometer' | 'gyroscope' | 'magnetometer' | 'accessibility-events' | 'clipboard-read' | 'clipboard-write' | 'payment-handler' | 'persistent-storage' | 'idle-detection' | 'midi-sysex';
     ...
     * @public
     */
    declare type PredefinedNetworkConditions = {
     ...
     * @public
     */
    declare type Product = 'chrome' | 'firefox';

    /**
     * Describes a launcher - a class that is able to create and launch a browser instance.
     * @public
     */
    declare interface ProductLauncher {
     ...
     * @public
     */
    declare class ProtocolError extends CustomError {
        code?: number;
     ...
     * @public
     */
    declare type PuppeteerErrors = Record<string, typeof CustomError>;

    /**
     * @public
     */
    declare const puppeteerErrors: PuppeteerErrors;
     ...
     * @public
     */
    declare class PuppeteerNode extends Puppeteer {
     ...
     * @public
     */
    declare type PuppeteerNodeLaunchOptions = BrowserLaunchArgumentOptions & LaunchOptions & BrowserConnectOptions;
     ...
     */
    declare function registerCustomQueryHandler(name: string, queryHandler: CustomQueryHandler): void;
    ...
    declare class SecurityDetails {
         ...
         * @returns {@link https://en.wikipedia.org/wiki/Unix_time | Unix timestamp}
          ...
          * @public
          */
         declare type TargetFilterCallback = (target: Protocol.Target.TargetInfo) => boolean;
          ...
          */
         declare function unregisterCustomQueryHandler(name: string): void;

         /**
          *  Unwraps a DOM element out of an ElementHandle instance
          * @public
          **/
         declare type UnwrapElementHandle<X> = X extends ElementHandle<infer E> ? E : X;
          ...
          * @public
          */
         declare interface WaitForTargetOptions {
             /**
...
export { Accessibility, ActionResult, BoundingBox, BoxModel, Browser, BrowserCloseCallback, BrowserConnectOptions, BrowserContext, BrowserContextEmittedEvents, BrowserContextOptions, BrowserEmittedEvents, BrowserFetcher, BrowserFetcherOptions, BrowserFetcherRevisionInfo, BrowserLaunchArgumentOptions, CDPSession, CDPSessionEmittedEvents, CDPSessionOnMessageObject, CSSCoverage, CSSCoverageOptions, ChromeReleaseChannel, ClickOptions, CommonEventEmitter, CommonPuppeteerSettings, ConnectOptions, Connection, ConnectionCallback, ConnectionEmittedEvents, ConnectionTransport, ConsoleAPICalledCallback, ConsoleMessage, ConsoleMessageLocation, ConsoleMessageType, ContinueRequestOverrides, Coverage, CoverageEntry, Credentials, CustomError, CustomQueryHandler, DEFAULT_INTERCEPT_RESOLUTION_PRIORITY, DOMWorld, Device, DevicesMap, Dialog, EVALUATION_SCRIPT_URL, ElementHandle, ErrorCode, EvaluateFn, EvaluateFnReturnType, EvaluateHandleFn, EventEmitter, EventType, ExceptionThrownCallback, ExecutionContext, FileChooser, Frame, FrameAddScriptTagOptions, FrameAddStyleTagOptions, FrameManager, FrameManagerEmittedEvents, FrameWaitForFunctionOptions, GeolocationOptions, HTTPRequest, HTTPResponse, Handler, InterceptResolutionAction, InterceptResolutionState, InterceptResolutionStrategy, InternalNetworkConditions, InternalQueryHandler, JSCoverage, JSCoverageEntry, JSCoverageOptions, JSHandle, JSONArray, JSONObject, KeyDefinition, KeyInput, Keyboard, LaunchOptions, LifecycleWatcher, MediaFeature, Metrics, Mouse, MouseButton, MouseOptions, MouseWheelOptions, NetworkConditions, NetworkManager, NetworkManagerEmittedEvents, Offset, PDFMargin, PDFOptions, Page, PageBinding, PageEmittedEvents, PageEventObject, PaperFormat, PaperFormatDimensions, Permission, Platform, Point, PredefinedNetworkConditions, PressOptions, Product, ProductLauncher, Protocol, ProtocolError, ProtocolLifeCycleEvent, ProtocolMapping, Puppeteer, PuppeteerErrors, PuppeteerEventListener, PuppeteerLifeCycleEvent, PuppeteerNode, PuppeteerNodeLaunchOptions, RemoteAddress, ResourceType, ResponseForRequest, ScreenshotClip, ScreenshotOptions, SecurityDetails, Serializable, SerializableOrJSHandle, SerializedAXNode, SnapshotOptions, Target, TargetFilterCallback, TimeoutError, TimeoutSettings, Touchscreen, Tracing, TracingOptions, UnwrapElementHandle, UnwrapPromiseLike, Viewport, WaitForOptions, WaitForSelectorOptions, WaitForTargetOptions, WaitTask, WaitTaskOptions, WaitTimeoutOptions, WebWorker, WrapElementHandle, clearCustomQueryHandlers, connect, connectToBrowser, createJSHandle, customQueryHandlerNames, devices, devicesMap, errors, getQueryHandlerAndSelector, keyDefinitions, launch, networkConditions, paperFormats, puppeteerErrors, registerCustomQueryHandler, unregisterCustomQueryHandler };
